...
| MCP-03 | Tool Poisoning                | N/A               | AIC exposes 9 tools (`aic_compile`, `aic_inspect`, `aic_projects`, `aic_quality_report`, `aic_status`, `aic_last`, `aic_model_test`, `aic_chat_summary`, `aic_compile_spec`). No dynamic tool loading, no third-party tool registry, no remote tool discovery.                                                                                                                                                                                                                                                                                                                             | Fixed tool set compiled into the binary                                                                 |
