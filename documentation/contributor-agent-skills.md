...
Procedures for repository development live under `.claude/skills/` as Agent Skill packages (one folder per skill, each with a `SKILL.md` entry point). Using those skills is optional.
...
Each subdirectory is one skill. Open `SKILL.md` for YAML `name` and `description` in frontmatter and for the full procedure.
...
| Skill folder               | Role                                                                                                                     |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| `aic-task-planner`         | Produces task files under `documentation/tasks/` with steps, tests, and acceptance criteria.                             |
...
For documentation-heavy tasks, the task planner documentation recipe delegates to the documentation-writer skill. The executor runs a second documentation-writer review pass after applying doc edits.
