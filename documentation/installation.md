...
| `devMode` in `aic.config.json`    | Cursor `preToolUse` gate hook                            | When `true`, skips dev-only compile gate enforcement for that project root (see [CONTRIBUTING.md](../CONTRIBUTING.md)).                                                                                                                        |
