...
> **First agentic tranche** labels early-shipped agentic pieces (before Phase 1 roadmap items such as `aic_compile_spec`). **Phase 0 / MVP** is the baseline product boundary in this table — the two labels are not the same.
