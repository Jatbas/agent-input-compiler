...
| `ConversationCompressor` _(Phase O — shipped)_ | Formats **recent** session steps (last 10 in the prompt) as a deterministic numbered list → `string` (see [§2.7](#27-agentic-workflow-support)) |
