...
| W12: Commands scoped by project                 | Done    | mcp/src/                                     | W07           | aic_status tool aggregates globally (all projects) with per-project breakdown when multiple projects exist. aic_last tool filters by the `projectRoot` from the most recent `aic_compile` call in the conversation (tracked via `conversationId`). `aic_chat_summary` adds `projectRoot` to the response. New `aic_projects` MCP tool lists all projects from the `projects` table (project ID, path, last seen, compilation count). `SqliteStatusStore` gains project-scoped query methods alongside its existing global methods. Update `.cursor/rules/AIC-architect.mdc` prompt command formatting rules. See impl-spec §W12.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Task 145: aic_status and aic_last MCP tools     | Done    | mcp/src/ + .cursor/rules/                    | W12           | Expose aic_status and aic_last as MCP tools; status/last resources removed. getStatusPayload/getLastPayload shared; lint:clones 0. Trigger rule prompt commands; aic-architect.mdc status/last use tool calls. Tests: aic_status returns project summary, aic_last returns last compilation, aic_status with no compilations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
**Components:** AB01 Comprehensive default ignore patterns (Task 147), AB02 Bootstrap artifact lifecycle management (Task 147), AC01 Fix server.close() runner cache watcher leak (Task 148)
**Completed:**
