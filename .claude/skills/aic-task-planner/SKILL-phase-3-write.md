...
| **AO**     | Exploration Report present                       | Every IN-SCOPE exploration finding (CHANGE-PATTERN, CONSUMER, CALLER CHAIN, TEST IMPACT, BEHAVIOR CHANGES, OPTIONAL FIELD HAZARDS) has a Files row / Step / Architecture Note / Follow-up entry.                                      | Add the missing row, bullet, or follow-up entry.                                                                                                                                                      |
