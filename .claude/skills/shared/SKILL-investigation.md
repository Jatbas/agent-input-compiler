...
7. **Stale marker scan:** In every file read during investigation, note `TODO`, `FIXME`, `HACK` markers and phase references. Cross-reference phase references against `documentation/mvp-progress.md`. Report actionable markers.
